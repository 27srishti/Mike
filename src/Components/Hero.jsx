    ...
    <div className="flex grid-cols-2  ">
      ...
      <div className="slide  ">
        <div className=" mt-[20%]  md:mt-[10%] w-[90%] pl-[10%]  absolute my-auto mx-auto ">
          <div class="relative  flex md:w-[36rem] 2xl:w-[72rem]  items-center">
            <div class=" w-5 mt-1 md:w-10  2xl:w-32 border-t border-[3px] border-green"></div>
            <span class="flex-shrink px-2 text-md  font-light  mx-auto  text-white 2xl:text-5xl  md:text-2xl">
              Networks Are Everywhere
            </span>
            <div class="flex-grow  mt-2 border-t  border-[3px] border-green"></div>
          </div>

          <h1 className="mt-3  md:w-[42rem] 2xl:leading-[4rem] 2xl:mt-10  2xl:w-[80rem] 2xl:text-5xl text-xl  font-semibold absolute  mx-auto  text-white  md:text-2xl ">
            {" "}
            ...
            <div className="mt-7 ">
              <a
                ...
                className="relative inline-flex items-center justify-start px-3 py-3 overflow-hidden w-28 2xl:w-40 2xl:h-20 font-medium transition-all bg-green rounded hover:bg-green group"
              >
