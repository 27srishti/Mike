...
const Hero = () => {
      ...
      <div className="slide  ">
        <div className=" mt-[20%]  md:mt-[10%] w-[90%] pl-[10%]  absolute my-auto mx-auto ">
          ...
          <h1 className="mt-3  md:w-[42rem]  text-xl  font-semibold absolute  mx-auto  text-white  md:text-2xl ">
            ...
            <div className="mt-7 ">
            <a href="https://www.networktigers.com/pages/all-products" className="relative inline-flex items-center justify-start px-3 py-3 overflow-hidden w-28 font-medium transition-all bg-green rounded hover:bg-green group">
  ...
  <span className="relative w-full text-left text-white text-center transition-colors duration-300 ease-in-out font-semibold text-sm group-hover:text-black">Explore More</span>
</a>
              {/* <a
