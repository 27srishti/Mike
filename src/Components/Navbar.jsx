    ...
    <section>
      <div className="  text-sm text-center  bg-gray-700 text-white justify-between flex grid-cols-2 mx-auto bg-opacity-90 h-7">
        <ui className="flex grid-cols-4 ">
          ...
          <div className=" border-l flex items-center bg-gray-500 px-10">
            Blog
          </div>
          <div className=" border-l flex items-center bg-gray-500 px-10">
            News
        ...
        <ui className="flex grid-cols-4 hidden lg:flex lg:block">
          ...
          <div className=" border-l flex items-center bg-amber-600 px-10">
            Ask For Quote
          </div>
        </ui>
      </div>
      ...
      {/* -------------------------------------------MiddleNav-End---------------------------------------------- */}
      <nav className="bg-lime-600 text-white text-xs sm:text-sm md:text-sm  lg:text-sm font-medium ">
