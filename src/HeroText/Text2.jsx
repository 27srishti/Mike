...
const Text2 = () => {
  return (
    <section>
      <div className=" mt-[10%]  md:mt-[10%] w-[90%] pl-[10%]  absolute my-auto mx-auto ">
        ...
        <h1 className="mt-3  capitalize md:w-[42rem]  text-xl  font-semibold absolute  mx-auto  text-white  md:text-2xl ">
          {" "}
          Since 1996, NetworkTigers has been offering fast shipment of
          <span className="text-white ">
            {" "}
            quality seller refurbished equipment to governments, schools,
